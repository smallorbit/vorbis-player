...
function DropboxLogo({ size }: { size: number }) {
  ...
  return (
    <svg width={iconSize} height={iconSize} viewBox="0 0 24 24" fill={PROVIDER_COLORS.dropbox}>
      <path d="M6 2l6 3.75L6 9.5 0 5.75zm12 0l6 3.75-6 3.75-6-3.75zM0 13.25L6 9.5l6 3.75L6 17zm12-3.75l6-3.75 6 3.75-6 3.75zm-5.98 4.75L12 17.99l6-3.75 6 3.75L12 24 0 17.99z" />
    </svg>
  );
}
