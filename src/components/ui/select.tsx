...
// Select primitive — neutral shadcn palette.
// Do NOT wire --primary or --accent to var(--accent-color).
//
// Per-part style escape hatches:
//   triggerStyle  → SelectTrigger button
//   contentStyle  → SelectContent dropdown panel
//   itemStyle     → each SelectItem row
...
const SelectTrigger = React.forwardRef<
  ...
  SelectTriggerProps
>(({ className, triggerStyle, style, children, ...props }, ref) => (
...
const SelectContent = React.forwardRef<
  ...
  SelectContentProps
>(({ className, contentStyle, style, children, position = "popper", ...props }, ref) => (
