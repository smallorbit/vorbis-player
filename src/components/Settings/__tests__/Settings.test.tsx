...
describe('Settings', () => {
  ...
  describe('desktop layout', () => {
    ...
    it('renders the desktop shell with the default section when ?settings=open', () => {
      // #given — 'open' is not a valid SettingsSectionId; it falls through to DEFAULT_SETTINGS_SECTION ('sources')
    ...
    // useKeyboardShortcuts.ts (setIsSettingsOpen(prev => !prev)) and belongs in a higher-level
