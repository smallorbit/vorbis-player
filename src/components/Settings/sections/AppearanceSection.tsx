...
/**
 * Settings Appearance section — phase 3 port (#1451).
 *
...
TranslucenceToggle.displayName = 'Settings.TranslucenceToggle';
...
AppearanceSection.displayName = 'Settings.AppearanceSection';
