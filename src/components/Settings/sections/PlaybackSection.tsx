...
VolumeBlock.displayName = 'Settings.PlaybackSection.VolumeBlock';
...
ShuffleBlock.displayName = 'Settings.PlaybackSection.ShuffleBlock';
...
PlaybackSection.displayName = 'Settings.PlaybackSection';
