...
export const ZEN_CONTROLS_OPACITY_EXIT_DURATION = 1200;
export const ZEN_CONTROLS_OPACITY_EXIT_DELAY = 1200;
export const ZEN_CONTROLS_TRANSFORM_EXIT_DELAY = 300;
